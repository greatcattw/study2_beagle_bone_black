			    ...
			    const struct i2c_device_id *id)
{
	...
	//Left Input Boost Mixer LINPUT3 = 5, 0dB
	regmap_update_bits(wm8960->regmap,WM8960_INBMIX1, 0x50, 0x50); 
	//Right Input Boost Mixer LINPUT3 = 5, 0dB
	regmap_update_bits(wm8960->regmap,WM8960_INBMIX2, 0x50, 0x50); 
	//Headphone = 121, 0dB
	//nouse, because unknow booting process change it. 
	regmap_update_bits(wm8960->regmap, WM8960_LOUT1, 0x179, 0x179);
	regmap_update_bits(wm8960->regmap, WM8960_ROUT1, 0x179, 0x179);
	//Playback = 255, 0dB
	//nouse, because unknow booting process change it.
	regmap_update_bits(wm8960->regmap, WM8960_LDAC, 0x1ff, 0x1ff);
	regmap_update_bits(wm8960->regmap, WM8960_RDAC, 0x1ff, 0x1ff);
	//ADC PCM = 195, 0dB
	//nouse, because unknow booting process change it.
	regmap_update_bits(wm8960->regmap, WM8960_LADC, 0x1C3, 0x1C3);
	regmap_update_bits(wm8960->regmap, WM8960_RADC, 0x1C3, 0x1C3);
